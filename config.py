...
class Config(object):
    ...
    ADMIN = int(os.environ.get("ADMIN", "1729311491"))

    # channels logs
    FORCE_SUB   = os.environ.get("FORCE_SUB", "-1002651801283") 
...
𝗔𝗻𝘆 𝗢𝘁𝗵𝗲𝗿 𝗛𝗲𝗹𝗽 𝗖𝗼𝗻𝘁𝗮𝗰𝘁 :- <a href=https://t.me/darknoor04>Developer</a>
"""
